...
print("🚦 Starting Traffic Congestion Analysis...")
...
print("⏰ Performing windowed analysis...")
...
if not top5_congested_pd.empty:
    ...
    fig1.update_layout(
        title="🚨 Top 5 Most Congested Roads (Speed Comparison)",
    ...
    fig1.show()
    print("✅ Visualization 1 updated successfully")
...
if not top5_congested_pd.empty:
    fig2 = px.bar(
        ...
        title="🔥 Speed Difference for Top 5 Congested Roads",
    ...
    fig2.show()
    print("✅ Visualization 2 created: Speed Difference Chart")
...
if not congestion_stats_pd.empty:
    fig3 = px.scatter(
        ...
        hover_name="name",
        title="🟡 Road Congestion Ratio Overview",
    ...
    fig3.show()
    print("✅ Visualization 3 created: Congestion Ratio Bubble Chart")
...
if not congestion_stats_pd.empty:
    ...
    fig4.show()
    print("✅ Visualization 4 updated successfully")
...
print("\n" + "="*60)
print("📊 TRAFFIC CONGESTION ANALYSIS SUMMARY")
print("="*60)
...
print(f"• Roads with Severe Congestion: {severe_congestion}")
print(f"• Average Speed Difference: {avg_speed_diff:.2f} km/h")
print(f"• Most Congested Road: {top5_congested_pd.iloc[0]['road_id'] if not top5_congested_pd.empty else 'N/A'}")
print(f"• Highest Speed Difference: {top5_congested_pd['avg_speed_difference'].max() if not top5_congested_pd.empty else 0:.2f} km/h")
