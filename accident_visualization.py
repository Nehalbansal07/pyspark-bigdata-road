...
print("📊 Creating Accident Impact Visualizations...")
...
try:
    ...
    print("❌ accident_alerts.csv not found. Please run ps-2.py first")
...
def create_alert_visualizations(df):
    ...
    fig1 = px.bar(
        ...
        title="🚨 Average Speed per Road during High Impact Accidents",
        labels={
    ...
    fig2.update_layout(
        title_text="📈 Detailed Accident Impact Analysis",
        height=600,
        showlegend=True
    )
    ...
    fig3.update_layout(
        title="🚦 Accident Alert Summary by Severity",
...
def create_general_analysis(df):
    ...
    fig = px.bar(
        ...
        x="road_id",
        y="avg_current_speed",
        title="🚗 General Traffic Analysis (No High Impact Alerts)",
        labels={
            "avg_current_speed": "Average Speed (km/h)",
            "road_id": "Road ID"
        }
...
print("🚨 Creating Accident Alert & Traffic Impact Dashboard...")
...
print("🎨 Creating Visualization 1: Accident Severity Overview...")
...
fig1.update_layout(
    title_text="🚗 ACCIDENT ANALYSIS OVERVIEW",
    height=700,
    showlegend=False,
    template="plotly_white"
)
...
print("🎨 Creating Visualization 2: Traffic Impact Analysis...")
...
fig2.update_layout(
    title_text="🚨 TRAFFIC IMPACT ANALYSIS",
    height=700,
    showlegend=True,
    template="plotly_white"
)
...
print("🎨 Creating Visualization 3: Real-time Alert Dashboard...")
...
print("🎨 Creating Visualization 4: Severity Heatmap...")
...
if not impact_alerts.empty and 'severity' in impact_alerts.columns:
    ...
    fig4.update_layout(
        title="🔥 TRAFFIC IMPACT HEATMAP BY ROAD AND SEVERITY",
        xaxis_title="Accident Severity",
        yaxis_title="Road ID",
        height=400,
        template="plotly_white"
...
print("🎨 Creating Visualization 5: Impact Recovery Timeline...")
...
if 'window_start' in impact_df.columns and not impact_alerts.empty:
    ...
    if recovery_data:
        ...
        fig5 = px.scatter(
            ...
            hover_data=['road_id'],
            title='🔄 TRAFFIC RECOVERY PATTERNS AFTER INCIDENTS',
            labels={
...
print("\n" + "="*60)
print("📊 ACCIDENT IMPACT ANALYSIS SUMMARY")
print("="*60)
...
if not impact_alerts.empty:
    ...
    print(f"🚨 High Impact Alerts: {total_alerts}")
    print(f"🛣  Roads Affected: {affected_roads}")
    print(f"📉 Average Speed During Incidents: {avg_impact_speed:.1f} km/h")
    print(f"📊 Lowest Recorded Speed: {min_speed:.1f} km/h")
    ...
    print(f"📈 Normal Traffic Speed Range: 25-40 km/h")
    print(f"🎯 Alert Threshold: < 8 km/h speed OR < 3 vehicles")
else:
    print("✅ No high impact incidents detected in the data")
    print("📊 Normal traffic conditions maintained")
